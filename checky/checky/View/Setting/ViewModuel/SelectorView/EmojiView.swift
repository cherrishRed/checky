...
struct EmojiView: View {
  ...
  @State var firstUnicode: any Strideable
  @State var lastUnicode: any Strideable
  ...
  func getEmojiList(_ firstUnicode: any Strideable, _ lastUnicode: any Strideable) -> [[Int]] {
    var emoji: [[Int]] = []
